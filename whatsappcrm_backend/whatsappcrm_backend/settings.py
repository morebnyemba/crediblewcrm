...
CHURCH_GIVING_DETAILS = {
    'BANK_NAME': os.getenv('CHURCH_BANK_NAME', 'Agribank'),
    'ACCOUNT_NUMBER': os.getenv('CHURCH_ACCOUNT_NUMBER', '100009498774'),
    'MERCHANT_CODE': os.getenv('CHURCH_MERCHANT_CODE', 'Ecocash Merchant : *030630'),
