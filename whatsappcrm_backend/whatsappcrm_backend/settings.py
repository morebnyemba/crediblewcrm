...
CHURCH_GIVING_DETAILS = {
    'BANK_1_NAME': os.getenv('CHURCH_BANK_1_NAME', 'Agribank'),
    'BANK_1_ACCOUNT': os.getenv('CHURCH_BANK_1_ACCOUNT', '100009498774'),
    'BANK_2_NAME': os.getenv('CHURCH_BANK_2_NAME', None),
    'BANK_2_ACCOUNT': os.getenv('CHURCH_BANK_2_ACCOUNT', None),
    'MERCHANT_CODE': os.getenv('CHURCH_MERCHANT_CODE', '030630'),
    'SWIFT_CODE': os.getenv('CHURCH_SWIFT_CODE', None),
    'DEFAULT_CURRENCY': os.getenv('DEFAULT_GIVING_CURRENCY', 'USD'),
}

# You can then add these to your .env file:
# CHURCH_BANK_1_NAME="Steward Bank"
# CHURCH_BANK_1_ACCOUNT="123456789"
# CHURCH_BANK_2_NAME="CBZ Bank"
# CHURCH_BANK_2_ACCOUNT="987654321"
# CHURCH_MERCHANT_CODE="*123*456*1#"
# CHURCH_SWIFT_CODE="STBLZWHX"
